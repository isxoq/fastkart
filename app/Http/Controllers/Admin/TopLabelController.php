...
class TopLabelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.topLabels.index', compact('topLabels'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.topLabels.create');
    }
    ...
    public function store(StoreTopLabelRequest $request)
    {
        ...
        return redirect()->route('admin.top-labels.index');
    }
    ...
    public function edit(TopLabel $topLabel)
    {
        ...
        return view('admin.topLabels.edit', compact('topLabel'));
    }
    ...
    public function show(TopLabel $topLabel)
    {
        ...
        return view('admin.topLabels.show', compact('topLabel'));
    }
