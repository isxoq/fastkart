...
class BanneSliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.banneSliders.index', compact('banneSliders'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.banneSliders.create');
    }
    ...
    public function store(StoreBanneSliderRequest $request)
    {
        ...
        return redirect()->route('frontend.banne-sliders.index');
    }
    ...
    public function edit(BanneSlider $banneSlider)
    {
        ...
        return view('frontend.banneSliders.edit', compact('banneSlider'));
    }
    ...
    public function show(BanneSlider $banneSlider)
    {
        ...
        return view('frontend.banneSliders.show', compact('banneSlider'));
    }
