...
class StaticPageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.staticPages.index', compact('staticPages'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.staticPages.create');
    }
    ...
    public function store(StoreStaticPageRequest $request)
    {
        ...
        return redirect()->route('frontend.static-pages.index');
    }
    ...
    public function edit(StaticPage $staticPage)
    {
        ...
        return view('frontend.staticPages.edit', compact('staticPage'));
    }
