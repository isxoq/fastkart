...
class SpecialOfferController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.specialOffers.index', compact('specialOffers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.specialOffers.create', compact('offers'));
    }
    ...
    public function store(StoreSpecialOfferRequest $request)
    {
        ...
        return redirect()->route('frontend.special-offers.index');
    }
    ...
    public function edit(SpecialOffer $specialOffer)
    {
        ...
        return view('frontend.specialOffers.edit', compact('offers', 'specialOffer'));
    }
    ...
    public function show(SpecialOffer $specialOffer)
    {
        ...
        return view('frontend.specialOffers.show', compact('specialOffer'));
    }
