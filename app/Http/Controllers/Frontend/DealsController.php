...
class DealsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.deals.index', compact('deals'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.deals.create', compact('products'));
    }
    ...
    public function store(StoreDealRequest $request)
    {
        ...
        return redirect()->route('frontend.deals.index');
    }
    ...
    public function edit(Deal $deal)
    {
        ...
        return view('frontend.deals.edit', compact('deal', 'products'));
    }
    ...
    public function show(Deal $deal)
    {
        ...
        return view('frontend.deals.show', compact('deal'));
    }
