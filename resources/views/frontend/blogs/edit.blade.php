                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.blogs.update", [$blog->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug', $blog->slug) }}">
                            @if($errors->has('slug'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="start" id="start" value="{{ old('start', $blog->start) }}">
                            @if($errors->has('start'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('start') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $blog->meta_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $blog->meta_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_tags" id="meta_tags" value="{{ old('meta_tags', $blog->meta_tags) }}">
