                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.top-labels.update", [$topLabel->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="content" id="content">{!! old('content', $topLabel->content) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.top-labels.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $topLabel->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
