                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="full_name" id="full_name" value="{{ old('full_name', $contact->full_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="profession" id="profession" value="{{ old('profession', $contact->profession) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="short_description" id="short_description" value="{{ old('short_description', $contact->short_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telegram" id="telegram" value="{{ old('telegram', $contact->telegram) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="facebook" id="facebook" value="{{ old('facebook', $contact->facebook) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="instagram" id="instagram" value="{{ old('instagram', $contact->instagram) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="whatsapp" id="whatsapp" value="{{ old('whatsapp', $contact->whatsapp) }}">
