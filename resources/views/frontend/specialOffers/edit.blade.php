                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.special-offers.update", [$specialOffer->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_1" id="title_1" value="{{ old('title_1', $specialOffer->title_1) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_2" id="title_2" value="{{ old('title_2', $specialOffer->title_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="url" id="url" value="{{ old('url', $specialOffer->url) }}">
                            @if($errors->has('url'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('url') }}
                                </div>
