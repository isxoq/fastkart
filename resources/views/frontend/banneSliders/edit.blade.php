                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.banne-sliders.update", [$banneSlider->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="content" id="content">{!! old('content', $banneSlider->content) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.banne-sliders.storeCKEditorImages') }}', true);
