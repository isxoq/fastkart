    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.deals.update", [$deal->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="begin" id="begin" value="{{ old('begin', $deal->begin) }}">
                            @if($errors->has('begin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('begin') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="end" id="end" value="{{ old('end', $deal->end) }}">
                            @if($errors->has('end'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('end') }}
                                </div>
