                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.offers.update", [$offer->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $offer->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="short_description" id="short_description" value="{{ old('short_description', $offer->short_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $offer->sort_order) }}" step="1">
