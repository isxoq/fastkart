                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.update", [$product->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $product->price) }}" step="0.01">
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_sale" id="is_sale" value="1" {{ $product->is_sale || old('is_sale', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sale" id="sale" value="{{ old('sale', $product->sale) }}" step="0.01">
                            @if($errors->has('sale'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sale') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="sale_start" id="sale_start" value="{{ old('sale_start', $product->sale_start) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="end_sale" id="end_sale" value="{{ old('end_sale', $product->end_sale) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $product->meta_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="meta_tags" id="meta_tags">{{ old('meta_tags', $product->meta_tags) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_trend" id="is_trend" value="1" {{ $product->is_trend || old('is_trend', 0) === 1 ? 'checked' : '' }}>
