                    ...
                    <form method="POST" action="{{ route("frontend.categories.update", [$category->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="status" id="status" value="1" {{ $category->status || old('status', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sort_order" id="sort_order" value="{{ old('sort_order', $category->sort_order) }}">
