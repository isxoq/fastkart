                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.banners.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_1" id="title_1" value="{{ old('title_1', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_3" id="title_3" value="{{ old('title_3', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_4" id="title_4" value="{{ old('title_4', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title_5" id="title_5" value="{{ old('title_5', '') }}">
