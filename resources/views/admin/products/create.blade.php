        ...
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_sale') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_sale" id="is_sale" value="1" {{ old('is_sale', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sale') ? 'is-invalid' : '' }}" type="number" name="sale" id="sale" value="{{ old('sale', '') }}" step="0.01">
                @if($errors->has('sale'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('sale_start') ? 'is-invalid' : '' }}" type="text" name="sale_start" id="sale_start" value="{{ old('sale_start') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_sale') ? 'is-invalid' : '' }}" type="text" name="end_sale" id="end_sale" value="{{ old('end_sale') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('meta_tags') ? 'is-invalid' : '' }}" name="meta_tags" id="meta_tags">{{ old('meta_tags') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_trend') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_trend" id="is_trend" value="1" {{ old('is_trend', 0) == 1 ? 'checked' : '' }}>
