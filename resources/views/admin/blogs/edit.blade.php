    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blogs.update", [$blog->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $blog->start) }}">
                @if($errors->has('start'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end') ? 'is-invalid' : '' }}" type="text" name="end" id="end" value="{{ old('end', $blog->end) }}">
                @if($errors->has('end'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $blog->meta_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_tags') ? 'is-invalid' : '' }}" type="text" name="meta_tags" id="meta_tags" value="{{ old('meta_tags', $blog->meta_tags) }}">
