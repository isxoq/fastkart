...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.banne-sliders.update", [$banneSlider->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content">{!! old('content', $banneSlider->content) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.banne-sliders.storeCKEditorImages') }}', true);
                ...
                data.append('crud_id', '{{ $banneSlider->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
