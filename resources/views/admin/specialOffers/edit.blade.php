    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.special-offers.update", [$specialOffer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content">{!! old('content', $specialOffer->content) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.special-offers.storeCKEditorImages') }}', true);
